...
var fs = require('fs');
 ...
 // Container for all of the helpers (for exporting)
 var helpers = {};
...
// Create a fcn to parse a JSON string w/o throwing an exception; how? ...
...
// Create a string if random alphanumeric charcters, of a given length
...
helpers.sendTwilioSms = function(phone, msg, callback){
  ...
  if(phone && msg){
    ...
    // End (meaning send) the request
    req.end();

  } else {
    callback('Specified parameters were missing or invalid.');
  }
};
...
helpers.interpolate = function(str, data){
  ...
  // Add the template globals to the data object, prepending their key name w/ "global"
